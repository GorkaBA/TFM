...
from ejecuciones_iniciales.var import nombres, geo_names
...
nombres = [
    ("balance", "balance-electrico","day",False),
...
def demanda(anno, tipo_demanda):
    try:
        if tipo_demanda[0] == "balance" and tipo_demanda[1] == "balance-electrico":
            # Manejar caso especial para "balance-electrico"
            api_url = f"https://apidatos.ree.es/es/datos/balance/balance-electrico-especial?end_date={anno}-12-31T23:59&time_trunc={tipo_demanda[2]}&start_date={anno}-01-01T04:00"
        else:
