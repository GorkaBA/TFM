...
for index, row in df.iterrows():
    ...
    for year in df_daily.index.year.unique():
        ...
        for month in range(1, 13):
            ...
            if df_month.empty:
                print(f"Mes {month} del año {year} para la comunidad {comunidad} está vacío. Saltando...")
                continue
...
df_final.to_csv('/home/azureuser/emisiones_diarias_gei_suavizado_ajustado.csv', index=False)