    ...
    for year in df_daily.index.year.unique():
        ...
        for num_sensor in range(1, 6):
            ...
            for fecha in df_year.index:
                ...
                valor_diario_ajustado = valor_suavizado / 24  # Dividir el valor diario entre 24 horas
                
                # Generar registros horarios
                for hora in range(24):
                    valor_final = round(valor_diario_ajustado * (1 + variacion), 6)  # Usar 6 decimales para mayor precisión
                    registros.append({
...
df_final.to_csv('/home/azureuser/emisiones_horarias_gei_suavizado.csv', index=False)