...
# Configuración
broker = "172.19.0.2"  # Dirección del broker MQTT
...
archivo_csv = '/home/azureuser/emisiones_gei_mqtt.xlsx'
...
def publish_messages():
    ...
    max_size = 10000  # Ajusta el tamaño máximo según tus necesidades
    contador = 0
