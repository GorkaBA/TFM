...
for index, row in df.iterrows():
    ...
    valores_anuales = {year: value for year, value in row.items() if year != "COMUNIDAD_AUTONOMA"}
    
    # Crear un DataFrame temporal para los valores mensuales
    ...
    # Crear una serie temporal diaria interpolada a partir de los valores mensuales
...
df_final.to_csv('/mnt/data/emisiones_diarias_gei_suavizado.csv', index=False)
