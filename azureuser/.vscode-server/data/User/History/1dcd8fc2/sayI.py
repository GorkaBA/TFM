...
timestamps_prev_year = [t.replace(year=t.year - 1) for t in timestamps]
...
next_week_timestamps_prev_year = [t.replace(year=t.year - 1) for t in next_week_timestamps]
next_week_timestamps_numeric = np.array(next_week_timestamps).reshape(-1, 1)
next_week_timestamps_prev_year_numeric = np.array(next_week_timestamps_prev_year).reshape(-1, 1)
