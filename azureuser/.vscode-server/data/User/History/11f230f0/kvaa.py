...
# Aplicar un filtro de suavizado a los valores
# df_final["Valor"] = uniform_filter1d(df_final["Valor"], size=2500)
alpha = 0.2  # Ajusta el valor de alpha según la cantidad de suavizado que desees
df_final["Valor"] = df_final["Valor"].ewm(alpha=alpha).mean()
