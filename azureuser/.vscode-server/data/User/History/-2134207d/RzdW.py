...
def load_data_anual(df_completo_anual):
    ...
    for index, row in df_completo_anual.iterrows():     
        ...
        point = point.field("CO2_comunidad_total", row.porcentaje_generacion_no_renovable)
        point = point.field("porcentaje_generacion_no_renovable", row.porcentaje_generacion_no_renovable)
        point = point.field("porcentaje_generacion_no_renovable", row.porcentaje_generacion_no_renovable)
        point = point.field("porcentaje_generacion_no_renovable", row.porcentaje_generacion_no_renovable)
        point = point.field("porcentaje_generacion_no_renovable", row.porcentaje_generacion_no_renovable)
...
df_completo_anual = df_completo_anual.rename(columns={'CO2_Total': 'CO2_comunidad_total(CO2-eq(kt))', 'Total_Value': 'CO2_estatal(CO2-eq(kt))', 'CO2_Value': 'CO2_comunidad_ajustado(CO2-eq(kt))', 'CO2_porcentaje_generacion': 'CO2_porcentaje_generacion(%)', ' CO2_ajustado_solo_generacion': ' CO2_ajustado_solo_generacion(CO2-eq(kt))'})
df_completo_anual = df_completo_anual.drop(columns=['CO2_comunidad_total(CO2-eq(kt))', 'CO2_estatal(CO2-eq(kt))'])
...
df_completo_mensual = df_completo_mensual.rename(columns={'CO2_Total': 'CO2_comunidad_total(CO2-eq(kt))', 'Total_Value': 'CO2_estatal(CO2-eq(kt))', 'CO2_Value': 'CO2_comunidad_ajustado(CO2-eq(kt))', 'CO2_porcentaje_generacion': 'CO2_porcentaje_generacion(%)', ' CO2_ajustado_solo_generacion': ' CO2_ajustado_solo_generacion(CO2-eq(kt))'})
df_completo_anual = df_completo_anual.drop(columns=['CO2_comunidad_total(CO2-eq(kt))', 'CO2_estatal(CO2-eq(kt))'])
...
columnas_interes = ['CO2_comunidad_total(CO2-eq(kt))', 'CO2_estatal(CO2-eq(kt))', 'CO2_España(CO2-eq(kt))', 'CO2_Comunidad(CO2-eq(kt))']

# Imprimir las columnas seleccionadas
print(df_completo_anual[columnas_interes])
###########
###Carga###
###########
