...
def calcular_porcentaje_CO2_respecto_contaminacion_total_mensual(CO2_España_Total_sensores_Mes, resultado_api_CO2_mes):
    ...
    df_combined['CO2_Percentage'] = (df_combined['CO2_Value'] * 100) / df_combined['Total_Value']
    resultado_calculo_final_mes = df_combined[['Año', 'Mes', 'CO2_Percentage']]
...
def intensidad_de_carbono_por_energia_generada_anual(CO2_Comunidad_Año, estructura_generacion_anual_total):
    ...
    intensidad_carbono_por_energia_generada_anual = merged_df[['Año', 'Comunidad', 'intensidad_carbono(g_CO₂/kWh)', 'CO2_ajustado_solo_generacion']]
...
def intensidad_de_carbono_por_energia_generada_mensual(CO2_Comunidad_Mes, estructura_generacion_mensual_total):
    ...
    merged_df['CO2_value_g'] = merged_df['CO2_value'] * 100_000
    merged_df['intensidad_carbono(g_CO₂/kWh)'] = merged_df['CO2_value_g'] / merged_df['_value']
...
ratio_energia_no_renovable_a_emisiones_de_CO2_mensual = ratio_energia_norenovable_a_emisiones_de_CO2_mensual(CO2_Comunidad_Mes, estructura_generacion_mensual_norenovable)
...
intensidad_carbono_por_energia_generada_mensual = intensidad_de_carbono_por_energia_generada_mensual(CO2_Comunidad_Mes, estructura_generacion_mensual_total)
