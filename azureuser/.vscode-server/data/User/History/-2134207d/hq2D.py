...
print("CO2_Comunidad_Año")
print(CO2_Comunidad_Año)
CO2_Comunidad_mes_ajustado = ultimos_calculos_CO2_merged_mensual[['Comunidad_Autonoma', 'Año', 'CO2_ajustado_solo_generacion']]
...
df_completo_mensual = pd.merge(CO2_Comunidad_mes_ajustado, df_completo_mensual, on=['Año', 'Mes', 'Comunidad'])
