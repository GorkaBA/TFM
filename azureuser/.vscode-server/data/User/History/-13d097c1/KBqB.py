...
# Asegurarse de que last_timestamp sea al comienzo del mes para evitar problemas
last_timestamp = last_timestamp.replace(day=1, hour=1, minute=0, second=0, microsecond=0)
next_months = [
    last_timestamp + relativedelta(months=1),
    last_timestamp + relativedelta(months=2)
]
