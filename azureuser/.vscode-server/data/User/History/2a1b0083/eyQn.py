        ...
        if year != "COMUNIDAD AUTONOMA":
            ...
            for num_sensor in range(1, 6):
                ...
                for dia in pd.date_range(start=f"{year}-01-01", end=f"{year}-12-31"):
                    ...
                    registros.append({"Fecha": dia, "Comunidad_Autanoma": comunidad, "Sensor": f"Sensor_{num_sensor}", "Valor": valor_final})
...
df_final.to_csv('/home/azureuser/archivo.csv', index=False)