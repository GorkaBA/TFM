...
for anno in range(1990, 2024):
    # Parámetros de la API
    api_url = f"https://apidatos.ree.es/es/datos/demanda/evolucion?end_date={anno+1}-05-19T23:59&time_trunc=day&start_date={anno}-06-04T04:00"
